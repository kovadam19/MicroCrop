	...
	Settings& settings)
{
	...
	while (simulation_time <= simulation_end_time)
	{
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of resetNodesCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateAxialSpringsCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateRotationalSpringsCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateNodesCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateIntersectionNodesCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateFacesCPU in milliseconds: " << duration.count() << std::endl;
		...
		stop = std::chrono::high_resolution_clock::now();
		duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
		std::cout << "Execution time of updateCellsCPU in milliseconds: " << duration.count() << std::endl;
