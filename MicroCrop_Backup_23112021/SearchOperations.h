...
inline __host__ __device__ int findClosestNodeToLocation(Node*				nodes,
												  int				number_of_nodes,
												  double3			location)
{
...
inline __host__ __device__ int findNodeInLocation(Node*		 nodes,
										   int			 number_of_nodes,
										   double3		 location)
{
	// Create a variable for the node index
...
// Find a cell node among the nodes based on its ID
